import { Component, OnInit, ViewChild, ChangeDetectorRef, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked } from '@angular/core';
...
export class AngularConceptsComponent implements OnInit, AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked {
  ...
  parentMessage:string = "This is a message from Parent Component to Child Component";
  childMessage:string ='';
  ...
  ngAfterViewInit() {
    ...
    console.log(this.child);
    setTimeout(()=>this.child.retrieveParentMessageToChild = "Text",0)
